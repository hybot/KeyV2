...
module k3d_surface_dish(width, height, depth, inverted) {
  ...
  scale([width*scale_factor/$k3d_surface_size/2,height*scale_factor/$3d_surface_size/2,depth])
    rotate([inverted ? 0:180,0,180])
      polar_3d_surface(size=$k3d_surface_size, step=$3d_surface_step, bottom=-10);
  /* %scale([width*scale_factor/$k3d_surface_size/2,height*scale_factor/$3d_surface_size/2,depth]) rotate([180,0,0]) polar_3d_surface(bottom=-10); */
